...
public class DataAdapter_mouth extends RecyclerView.Adapter<DataAdapter_mouth.ViewHolder> {


    public static interface OnItemClickListener{
        void onItemClick(View view);
    }
    private DataAdapter_mouth.OnItemClickListener itemClickListener;
    public void setItemClickListener(DataAdapter_mouth.OnItemClickListener listener){
    ...
    public DataAdapter_mouth(List<String> data,int position) {
        this.mdata = data;
