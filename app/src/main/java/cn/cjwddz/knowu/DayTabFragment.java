...
public class DayTabFragment extends Fragment implements Get_M_callback, Get_D_callback, SetDate_interface {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SetDateListenerManager.getInstance().setConnectionStateListener(this);
    ...
    private void initmData(){
        ...
        param.put("time",sb);
        //网络请求
        getUserRecord(Constants.GET_MONTH_OF_DAY,param);
    ...
    private void findView(View v){
        ...
        tv_fighting_hour =  v.findViewById(R.id.tv_fighting_hour);
        tv_fighting_min =  v.findViewById(R.id.tv_fighting_min);
        tv_userTime =  v.findViewById(R.id.tv_userTime);
        tv_fighting_one_min =  v.findViewById(R.id.tv_fighting_one_min);
        tv_fighting_max_intensity =  v.findViewById(R.id.tv_fighting_max_intensity);
        tv_fighting_average_intensity =  v.findViewById(R.id.tv_fighting_average_intensity);
        tv_percent_time =  v.findViewById(R.id.tv_percent_time);
        tv_percent_value =  v.findViewById(R.id.tv_percent_value);
        gradientGraphView_time =  v.findViewById(R.id.gradientGraphView_time);
        gradientGraphView_intensity =  v.findViewById(R.id.gradientGraphView_intensity);
        btn_user_feel =  v.findViewById(R.id.btn_user_feel);
...
//解决数据加载完成后, 没有停留在顶部的问题
        ...
        madapter = new DataAdapter(mdata,day);
        ...
        try {
            ...
            if(jsonObject.getBoolean("status")){
                ...
                if(!data.isNull("longest")){
                    JSONObject longest = data.optJSONObject("longest");
        ...
        try {
            ...
            if(status){
                ...
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        madapter.setMData(mdata,day);
                        adapter1.setMDatae(mdate);
                    }
                });
                getUserRecordOfDay(Constants.GET_DAY,putMap(day));
                //System.out.println("获得的数据day:"+mdata+mdata.size());
            }else{
...
View.OnClickListener listener1 = new View.OnClickListener() {
    ...
    public void getDateDay(String s,Map m,int p) {
        ...
        day = p;
        lastposition = p;
        getUserRecord(Constants.GET_MONTH_OF_DAY,m);
    }
    /**
     * 请求登录
     * */
